 ...
 * and the AJAX endpoints used by the settings interface.
 *
...
/**
 * SOURCE: Part-4 and Part-5 of Complete Technical Implementation Guide (ANSP_Admin_Settings logic)
 * IMPLEMENTATION: NDS_Admin_Settings with AJAX support and capability checks.
 */
...
class NDS_Admin_Settings {
	...
	/**
	 * Display the main settings page with tabbed navigation
	 * [cite: 15, 731-740]
	 *
	 * @since    1.0.0
	 */
	...
	/**
	 * Display the sitemap validation tool
	 * [cite: 15, 760-765]
	 *
	 * @since    1.0.0
	 */
	...
	/**
	 * AJAX: Validate the sitemap against Google News standards
	 * [cite: 15, 829-861]
	 *
	 * @since    1.0.0
	 */
	...
	/**
	 * AJAX: Perform a manual ping to enabled search engines
	 * [cite: 15, 867-882]
	 *
	 * @since    1.0.0
	 */
	...
	/**
	 * AJAX: Clear all transient and object caches
	 * [cite: 15, 888-902]
	 *
	 * @since    1.0.0
	 */
	...
	/**
	 * Add Settings link on the main WordPress Plugins page
	 * [cite: 15, 910-918]
	 *
	 * @since    1.0.0
	 */
	...
	/**
	 * Display dismissible admin notices for activation and configuration
	 * [cite: 15, 924-943]
	 *
	 * @since    1.0.0
	 */
	public function display_admin_notices() {
		...
		$pub_name = get_option( 'nds_publication_name', '' );
		if ( empty( $pub_name ) ) {
			printf(
