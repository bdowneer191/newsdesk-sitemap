...
class NDS_Core {
	...
	private function load_dependencies() {
		...
		/**
		 * Admin-specific classes - CRITICAL FIX [cite: 9081-9089]
		 */
		if ( is_admin() ) {
	...
	private function define_admin_hooks() {
		...
		$stock_ticker_meta = new NDS_Stock_Ticker_Meta();
		$this->loader->add_action( 'add_meta_boxes', $stock_ticker_meta, 'add_meta_box' );
		$this->loader->add_action( 'save_post', $stock_ticker_meta, 'save_meta_box', 10, 2 );
	...
	/**
	 * Register all hooks related to the ping service.
	 * [cite: 3579-3589]
	 *
	 * @since    1.0.0
	 * @access   private
