...
function activate_nds() {
	try {
        ...
        // We do NOT re-throw the exception so the site doesn't crash 
        // to the white screen of death, but the plugin might not be fully functional.
        // In a strict environment, you might want to `wp_die()` with a friendly message.
    } catch ( Error $e ) {
